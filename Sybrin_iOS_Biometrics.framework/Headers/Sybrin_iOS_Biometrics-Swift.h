...
typedef SWIFT_ENUM(NSInteger, BiometricsStatus, open) {
  BiometricsStatusNotInitialized = 0,
  BiometricsStatusInitializationFailed = 1,
  BiometricsStatusReadyToScan = 2,
...
SWIFT_CLASS("_TtC21Sybrin_iOS_Biometrics16FaceCompareModel")
...
SWIFT_CLASS("_TtC21Sybrin_iOS_Biometrics34FaceRecognitionAuthenticationModel")
@interface FaceRecognitionAuthenticationModel : BiometricsModel
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC21Sybrin_iOS_Biometrics28FaceRecognitionTrainingModel")
@interface FaceRecognitionTrainingModel : BiometricsModel
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic, readonly) enum BiometricsStatus status;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
